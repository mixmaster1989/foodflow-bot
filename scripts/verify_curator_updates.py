...
async def test_scenarios():
    ...
    async for session in get_db():
        ...
        curator.referral_token_expires_at = datetime.utcnow() - timedelta(minutes=1)
        await session.commit()
        ...
        if found_curator and found_curator.referral_token_expires_at < datetime.utcnow():
        ...
        marathon.invite_token_expires_at = datetime.utcnow() - timedelta(minutes=1)
        await session.commit()
